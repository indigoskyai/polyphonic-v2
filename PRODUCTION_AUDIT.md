...
### Blocked
- Hosted observability metrics are not available from the local repo alone: last-5xx-in-7d and last-24h cron success rates require Lovable/Supabase logs or service-role production access. Static source inventory is recorded below.
