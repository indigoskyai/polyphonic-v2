-- Self-service account portability for Polyphonic/Luca.
-- Archives are encrypted before storage; row_map gives rollback and audit a
-- precise import boundary without time-window cleanup.
...
VALUES ('account-portability', 'account-portability', false, 104857600)
