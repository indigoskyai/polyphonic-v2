...
--
-- `journal-write` already sends source_conversation_id. Some production
-- schemas do not yet have the column, which makes journal writes fail at
-- insert time. Keep this additive and nullable so old rows remain valid.
