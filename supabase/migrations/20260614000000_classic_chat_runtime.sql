-- Classic Chat runtime metadata. Existing threads remain agent-mode by default;
-- the frontend explicitly creates ordinary new chats with runtime_mode='classic'.
