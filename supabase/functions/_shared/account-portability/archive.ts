...
export const PORTABLE_TABLES: PortableTableConfig[] = [
  ...
  { name: "group_messages", idColumn: "id", userColumn: "sender_user_id", jsonColumns: ["attachments", "metadata"], importBatchSize: 100, readOnly: true },
  { name: "group_memory_candidates", idColumn: "id", userColumn: "user_id", jsonColumns: ["metadata"], readOnly: true },
