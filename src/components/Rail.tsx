...
export default function Rail() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-y-0 left-0 flex flex-col items-center cursor-pointer"
        style={{
          ...
          transition: expanded ? 'opacity 150ms var(--ease-out)' : 'opacity 200ms var(--ease-out) 200ms',
        }}
        onClick={(e) => {
      ...
      <div
        ...
        style={{
          ...
          transition: expanded ? 'opacity 200ms var(--ease-out) 200ms' : 'opacity 150ms var(--ease-out)',
        }}
      >
        {/* Header */}
            ...
            <div style={{ paddingBottom: 4, marginBottom: 4, borderBottom: '1px solid var(--border-subtle)' }}>
              ...
              {pinnedThreads.map((t) => (
                <ThreadItem
                  ...
                  onClick={() => { navigate(`/chat/${t.id}`); setExpanded(false); }}
                />
              ))}
            </div>
          )}
