...
const MODEL_CARDS = [
  ...
  { id: 'openai/gpt-5.5', name: 'GPT-5.5', desc: 'OpenAI newest frontier model', badge: 'deep' },
  ...
  { id: 'deepseek/deepseek-v4-pro', name: 'DeepSeek V4 Pro', desc: '1.6T MoE, 1M context', badge: 'deep' },
  { id: 'deepseek/deepseek-v4-flash', name: 'DeepSeek V4 Flash', desc: 'Fast DeepSeek V4 variant', badge: 'fast' },
  { id: 'deepseek/deepseek-v3.2', name: 'DeepSeek V3.2', desc: 'Open-source frontier reasoning', badge: 'deep' },
  { id: 'moonshotai/kimi-k2.6', name: 'Kimi K2.6', desc: 'Moonshot multimodal coding agent', badge: 'deep' },
  { id: 'moonshotai/kimi-k2.5', name: 'Kimi K2.5', desc: 'Moonshot multimodal flagship', badge: 'fast' },
